...
#model_train_ts = pd.DataFrame(m.train["guests"])
#
...
#tsplot(model_train_ts.guests, lags = 60)

## Getting rid of stationarity
#guests_diff = model_train_ts.guests - model_train_ts.guests.shift(52)
##tsplot(guests_diff[52:], lags=60)
#
## First differences
...
d=0 # number of differences used 
...
qs = range(3, 5) # set range between number of steps in sequence on the Autocorrelation plot
