...
exog_variables = np.column_stack((
          posData['severity_diff'].values,
          posData['humidity_diff'].values,
...
def optimizeSARIMA(parameters_list, d, D, s):
    ...
    for param in tqdm_notebook(parameters_list):
        ...
        try:
            model = sm.tsa.SARIMAX(posData["guests_diff"], exog= exog_variables, enforce_invertibility=False, order=(param[0], d, param[1]), 
